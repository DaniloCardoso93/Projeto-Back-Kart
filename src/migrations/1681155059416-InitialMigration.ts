...
export class InitialMigration1681155059416 implements MigrationInterface {
    name = 'InitialMigration1681155059416'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "announcement" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying(50) NOT NULL, "model" character varying(50) NOT NULL, "year" character varying(10) NOT NULL, "fuel" character varying(100) NOT NULL, "odometer" character varying(50) NOT NULL, "color" character varying(50) NOT NULL, "fipe" character varying(50) NOT NULL, "price" character varying(50) NOT NULL, "description" character varying(250) NOT NULL, "isPublished" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e0ef0550174fd1099a308fd18a0" PRIMARY KEY ("id"))`);
